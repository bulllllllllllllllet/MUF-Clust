...
CHANNEL_CONFIGS: Dict[str, List[ChannelSpec]] = {
    "KidneyCancer": [
        ...
        ChannelSpec(2, "Opal570", "FOXP3", "细胞核"),
        ChannelSpec(3, "Opal690", "CD8", "细胞膜"),
        ChannelSpec(4, "Opal480", "CD20", "细胞膜"),
        ChannelSpec(5, "Opal620", "CD23", "细胞膜"),
        ChannelSpec(6, "Opal780", "PAX8s", "细胞核"),
        ChannelSpec(7, "Opal520", "CD3", "细胞膜"),
        ChannelSpec(8, "SampleAF", "AF", "细胞自发荧光（背景）", is_af=True),
    ],
    "BladderCancer": [
        ChannelSpec(1, "DAPI", "-", "核染色", is_dapi=True),
        ChannelSpec(2, "Opal570", "FOXP3", "细胞核"),
        ChannelSpec(3, "Opal690", "PD-L1", "细胞膜"),
        ChannelSpec(4, "Opal480", "PANCK", "细胞质"),
        ChannelSpec(5, "Opal620", "CD4", "细胞膜"),
        ChannelSpec(6, "Opal780", "CXCL13", "细胞核"),
        ChannelSpec(7, "Opal520", "IgM", "细胞膜"),
        ChannelSpec(8, "SampleAF", "AF", "细胞自发荧光（背景）", is_af=True),
    ],
}
